...
int main(int argc, char *argv[])
{
  ...
  int n = 0;
  double p = 0.0, r = 0.0, M_PI = 3.14; 
  
  g2_pen(dev, 19);
  g2_set_line_width(dev, 1);
 
  
  g2_line(dev, 350, 235, 350, 205);
   for(n = 0; n < 13; n++)
     {
      p = 350 - 30*sin(n*M_PI/6.0);
      r = 235 - 30*cos(n*M_PI/6.0);
  ...
  for(f = 0; f < 13; f++)
    {
      x3 = 430 - 30*sin(f*M_PI/6.0);
      y3 = 235 - 30*cos(f*M_PI/6.0);
      g2_line(dev, 430, 235, x3, y3);
    }
      
    g2_set_line_width(dev,0);
    g2_pen(dev, 0);
    g2_filled_circle(dev,430, 235, 20);
